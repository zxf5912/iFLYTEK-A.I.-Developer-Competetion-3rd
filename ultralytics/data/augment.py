...
class BaseTransform:
    ...
    def apply_image(self, labels):
        """Applies image transformation to labels1."""
        pass

    def apply_instances(self, labels):
        """Applies transformations to input 'labels1' and returns object instances."""
        pass
...
class Mosaic(BaseMixTransform):
    ...
    def _mix_transform(self, labels):
        """Apply mixup transformation to the input image and labels1."""
    ...
    def _cat_labels(self, mosaic_labels):
        """Return labels1 with mosaic border instances clipped."""
...
class LetterBox:
    ...
    def __call__(self, labels=None, image=None):
        """Return updated labels1 and image with added border."""
        if labels is None:
            labels = {}
...
class CopyPaste:
    ...
    def __call__(self, labels):
        """Implement Copy-Paste augmentation https://arxiv.org/abs/2012.07177, labels1 as nx5 np.array(cls, xyxy)."""
        im = labels['img']
        cls = labels['cls']
        h, w = im.shape[:2]
        instances = labels.pop('instances')
