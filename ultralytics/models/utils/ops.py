...
def get_cdn_group(batch,
    ...
    positive and negative samples from the ground truths (gt). It applies noise to the class labels1 and bounding
    box coordinates, and returns the modified labels1, bounding boxes, attention mask and meta information.
